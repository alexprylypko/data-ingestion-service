...
/// <summary>
/// Represents a request to ingest a streamed batch of CSV transactions.
/// </summary>
public sealed class IngestBatchCommand
{
    /// <summary>
    /// Initializes the command with the streamed CSV rows.
    /// </summary>
    public IngestBatchCommand(IAsyncEnumerable<CsvTransactionRow> rows)
        => Rows = rows;

    /// <summary>
    /// The streamed CSV rows to ingest without materializing them all in memory.
    /// </summary>
