...
/// <summary>Handles summary-statistics queries across all ingested transactions.</summary>
public sealed class GetSummaryStatsQueryHandler
{
    private readonly ITransactionReadRepository _transactionRepository;

    /// <summary>Initialises the handler with the read repository used for aggregate queries.</summary>
    public GetSummaryStatsQueryHandler(ITransactionReadRepository transactionRepository)
        => _transactionRepository = transactionRepository;

    /// <summary>Returns aggregate transaction summary statistics.</summary>
