...
/// <summary>
/// Represents a CSV row describing a single transaction ingestion request.
/// </summary>
public sealed class CsvTransactionRow
{
    ...
    /// <summary>
    /// Transaction date as provided in the CSV source.
    /// </summary>
    public string TransactionDate { get; set; } = string.Empty;

    /// <summary>
    /// Monetary amount as provided in the CSV source.
    /// </summary>
...
/// <summary>
/// Maps CSV column names to <see cref="CsvTransactionRow"/> properties.
/// </summary>
public sealed class CsvTransactionRowMap : ClassMap<CsvTransactionRow>
{
    /// <summary>
    /// Initializes the CSV column map.
    /// </summary>
