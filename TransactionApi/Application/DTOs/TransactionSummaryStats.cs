...
/// <summary>
/// Represents aggregate reporting data across all stored transactions.
/// </summary>
public sealed class TransactionSummaryStats
{
    /// <summary>
    /// Total number of transactions stored in the system.
    /// </summary>
    ...
    /// <summary>
    /// Timestamp of the oldest transaction in the data set.
    /// </summary>
    public DateTimeOffset? OldestTransaction { get; set; }

    /// <summary>
    /// Timestamp of the newest transaction in the data set.
    /// </summary>
    public DateTimeOffset? NewestTransaction { get; set; }

    /// <summary>
    /// Breakdown of stored transactions by currency.
    /// </summary>
...
/// <summary>
/// Represents a currency-level transaction summary.
/// </summary>
...
public sealed class CurrencyBreakdown
{
    ...
    /// <summary>
    /// Total number of transactions in the currency bucket.
    /// </summary>
    public int Count { get; set; }

    /// <summary>
    /// Total amount represented by the currency bucket.
    /// </summary>
    public decimal TotalAmount { get; set; }
}

/// <summary>
/// Represents a source-channel transaction summary.
/// </summary>
public sealed class ChannelBreakdown
{
    /// <summary>
    /// Name of the source channel bucket.
    /// </summary>
